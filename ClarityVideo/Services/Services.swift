...
enum AppError: LocalizedError, Sendable {
    ...
    var errorDescription: String? {
        ...
        case let .insufficientStorage(required, available): "Not enough free storage. This export needs about \(ByteCountFormatter.string(fromByteCount: required, countStyle: .file)) free while it runs; \(ByteCountFormatter.string(fromByteCount: available, countStyle: .file)) is available."
